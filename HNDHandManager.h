...
-(CGPoint)_eventManagerPointForGesture:(id)arg1 fingerIdentifier:(id)arg2 eventIndex:(unsigned long long)arg3 ;
-(CGPoint)_originPointFromMidPoint:(CGPoint)arg1 shouldConvertToOrientation:(BOOL)arg2 ;
